...
const App = () => {
  ...
  return (
    <>
      {/* Nearby Pharmacy Floating Button - এটি সবার উপরে থাকবে */}
      <div className="floating-action-button" onClick={() => window.open('https://www.google.com/maps/search/pharmacy+near+me', '_blank')}>
        <MapPin size={24} />
        <span className="fab-text">Nearby Pharmacy</span>
      </div>
